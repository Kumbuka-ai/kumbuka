...
- **Selbst gehostet** — Sie betreiben den Docker-Compose-Stack auf Ihrer eigenen
  Infrastruktur ([Schnellstart](/de/get-started/quickstart/)).
...
wie es unter [Sicherheit & Datenschutz](/de/operations/security/) beschrieben ist.
...
anzubieten (siehe [Sicherheit & Datenschutz](/de/operations/security/#network-source-obligation-agpl-13)).
