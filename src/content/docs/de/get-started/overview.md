...
[Konzepte](/de/concepts/data-model/); wie ein Assistent es aufruft, zeigen die
[MCP-Tools](/de/reference/mcp-tools/).
...
- **Privates Gedächtnis** ist der eigene Arbeitsbereich jedes Mitglieds. Es ist
  **nur** durch dieses Mitglied erreichbar, **nur** über dessen eigene
  ...
  durch eine Einstellung (siehe [Sicherheit & Datenschutz](/de/operations/security/)).
...
[Schnellstart](/de/get-started/quickstart/), um ihn selbst zu hosten, und die
[Architektur](/de/operations/architecture/) für die Topologie.
...
geplant, aber pre-beta — siehe [Editionen](/de/concepts/editions/). Er wird
