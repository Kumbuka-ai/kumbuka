...
[Configuration](/en/reference/configuration/) and in the
...
- [Configuration](/en/reference/configuration/) — policies and environment knobs.
- [Architecture](/en/operations/architecture/) — what each container does and how requests
  flow.
- [Security & privacy](/en/operations/security/) — the private guarantee and the operational
