...
[Configuration](/en/reference/configuration/)). `private` is always available to each
...
governed by the team's default write-scope policy. See [MCP tools](/en/reference/mcp-tools/)
and [Configuration](/en/reference/configuration/).
